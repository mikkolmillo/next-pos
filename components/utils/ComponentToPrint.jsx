              ...
              <tr key={item.id} className="border-b border-gray-200">
                <td className="py-4 pl-4 pr-3 text-sm sm:pl-6 md:pl-0">
                  ...
                  <div className="mt-0.5 text-gray-500 sm:hidden">
                    {item.amount} pcs at ${item.price}
                  </div>
                </td>
                <td className="hidden py-4 px-3 text-right text-sm text-gray-500 sm:table-cell">{item.name}</td>
                <td className="hidden py-4 px-3 text-right text-sm text-gray-500 sm:table-cell">{item.price}</td>
                <td className="py-4 pl-3 pr-4 text-right text-sm text-gray-500 sm:pr-6 md:pr-0">{item.amount}</td>
              </tr>
            ))}
          </tbody>
          <tfoot>
